...
from Participated,Accident where Participated.report_num=Accident.report_num and accident_date like '2008%'; 
select count(Participated.report_num) No_ACC from Car,Participated where Car.reg_num=Participated.reg_num and Car.model='Indica'; 
