...
USE COLLEGEDB;
CREATE TABLE STUDENT ( USN VARCHAR (10), SNAME VARCHAR (25), ADDRESS VARCHAR (25), PHONE LONG, GENDER CHAR (1),PRIMARY KEY (USN)); 
CREATE TABLE SEMSEC ( SSID VARCHAR (5), SEM INT, SEC CHAR (1), PRIMARY KEY (SSID)); 
